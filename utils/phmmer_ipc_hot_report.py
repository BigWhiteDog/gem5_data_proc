...
def report_hmmer(s_dicts:dict):
    ...
    plt.savefig(f'hot.png',dpi=300)

if __name__ == '__main__':
    all_base  = '/nfs/home/zhangchuanqi/lvna/5g/ff-reshape/log/new_hw_test/period5/try-waymask/period_hmmer_o3_0-period_hmmer_o3_3-period_hmmer_o2_0-period_hmmer_o2_2'
    st_dict = {}
