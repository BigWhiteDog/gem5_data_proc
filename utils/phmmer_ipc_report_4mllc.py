...
def report_hmmer(base_dir,last_nsamples = 4):
    ...
    plt.savefig(f'4mllc_speedup.png',dpi=300)


if __name__ == '__main__':
    # t_work_combine = ['hmmer_o31-hmmer0-hmmer_o30-hmmer1']
    report_hmmer('/nfs/home/zhangchuanqi/lvna/5g/ff-reshape/log/new_hw_test/4MLLC/period5/try-waymask/period_hmmer_o3_0-period_hmmer_o3_3-period_hmmer_o2_0-period_hmmer_o2_2')