...
def profile_hmmer(s_dicts:dict):
    ...
    im, cbar = heatmap(slowdowns,row_labels,col_labels,ax=now_ax,cmap='YlGn',cbarlabel='slowdown',aspect='auto')
    texts = annotate_heatmap(im, valfmt='{x:.3f}')
    
    # fig.tight_layout()
    plt.savefig(f'profiling_phmmer0.png',dpi=300)
