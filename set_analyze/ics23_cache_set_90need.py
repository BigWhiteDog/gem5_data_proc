...
def draw_db_by_func(base_dir,n_rows,worksname_waydict,draw_one_func,fig_name,n_cols=6):
    ...
    work_stats_dict = {}
    json_path = '/nfs/home/zhangchuanqi/lvna/5g/gem5_data_proc/set_analyze/newdb50M-other/json/ics23_cache_set_90need.json'
    ...
    fig.set_size_inches(n_cols*6, 4*n_rows)
...
if __name__ == '__main__':
    ...
    draw_db_by_func(base_dir,n_rows,cache_work_95perfmax8ways,
        draw_one_func=draw_one_workload_way_need,fig_name=os.path.join(pic_dir_path,'ics23_way_need_95perfmax8_dis.png'))
