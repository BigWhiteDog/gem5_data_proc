...
if __name__ == '__main__':
    ...
    draw_db_by_func(base_dir,n_rows,cache_work_90perfways,
        draw_one_func=draw_one_workload_block_need,fig_name=os.path.join(pic_dir_path,'set_dead_90perf_dis.png'))
    draw_db_by_func(base_dir,n_rows,cache_work_95perfways,
        draw_one_func=draw_one_workload_block_need,fig_name=os.path.join(pic_dir_path,'set_dead_95perf_dis.png'))
    draw_db_by_func(base_dir,n_rows,cache_work_fullways,
        draw_one_func=draw_one_workload_block_need,fig_name=os.path.join(pic_dir_path,'set_dead_dis.png'))
