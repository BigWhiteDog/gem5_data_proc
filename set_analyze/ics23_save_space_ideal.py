...
def draw_one_ideal_savespace(ax,s_dicts,workload_name,full_ass,pos:tuple):
...
if __name__ == '__main__':
    ...
    draw_picformat = [
        (draw_one_ideal_savespace,'ics23_ideal_save_{}.png',os.path.join(csv_dir_path,'min0way_{}')),
    ]
